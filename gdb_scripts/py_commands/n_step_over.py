...
class NStepOver(gdb.Command):
    ...
    def __init__(self):
        ...
        """
        self.__command_name = "n_step_over"
        self.__num_args = 1
        self.__ret_variable_gdb = "${}_ret".format(self.__command_name)

        self.__messenger = Messenger()
        super(NStepOver, self).__init__(self.__command_name, gdb.COMMAND_USER)
        self.__usage()
        return
    ...
    def invoke(self,
        ...
        self.__messenger.print_message(Severity.INFO, "Stepping over {} instructions...".format(num_steps))
